...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM1,   CH1,  PA8,   TIM_USE_MOTOR, 0, 1 ), // S2_OUT –  DMA2_ST6, *DMA2_ST1, DMA2_ST3
    DEF_TIM(TIM1,   CH2,  PA9,   TIM_USE_MOTOR, 0, 1 ), // S1_OUT – *DMA2_ST6,  DMA2_ST2
    
//    DEF_TIM(TIM4,   CH3,  PB8,   TIM_USE_ANY,   0, 0 ), // FC CAM – DMA1_ST7
//    DEF_TIM(TIM10,  CH1,  PB8,   TIM_USE_ANY,   0, 0 ), // Cam Control
